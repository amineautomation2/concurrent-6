...
from utils import clean_spreadsheet, delay, get_random_user_agent, get_xlsx_filepath, write_json, fetch_with_backoff
...
def page_payload(page: int):
    payload = {
        "FilteringOptions": {
            "undefined": 0,
            "RangeId": "17200457", "Yield": {}, "RangeName": "", "CategoryId": None, "Category2Id": None, "PriipProductCode": None, "DefaultCategoryId": None, "DefaultCategory2Id": None, "ForSaleIn": None, "ShowMainUnits": False, "MPCategoryCode": None}, "ProjectName": "chelseafinancial", "LanguageCode": "en-gb", "LanguageId": "1", "Theme": "chelsea", "SortingStyle": "1", "PageNo": page, "PageSize": 100, "OrderBy": "UnitName:init", "IsAscOrder": True, "OverrideDocumentCountryCode": None, "ToolId": "1", "PrefetchPages": 200, "PrefetchPageStart": page, "OverridenThemeName": "chelsea", "ForSaleIn": "", "ValidateFeResearchAccess": False, "HasFeResearchFullAccess": False, "EnableSedolSearch": "false", "GrsProjectId": "16000034", "ShowMainUnitExpansion": False, "UseCombinedOngoingChargeTER": False
    }
...
def chelsea_runner() -> list[dict]:
    ...
    while has_next:
        ...
        url = 'https://digitalfundservice.feprecisionplus.com/FundDataService.svc/GetRowIdList?jsonString=' + payload_encoded
        # print(url)
        ...
        if res is not None:
            ...
            if page == 1:
                ...
                print(
                    f'[###] Total Funds found: {json_data["TotalRows"]} [###]')
            print(f'[#] Page {page} of {total_pages}')
            data = sub(r'\r\n\s', '', json_data["Units"])
            funds_per_page = json.loads(data)["DataList"]
            fund_base_url = f'https://digital.feprecisionplus.com'
            fund_idx = 1
...
def write_row(x: int, y: int, val: str) -> None:
    pass
